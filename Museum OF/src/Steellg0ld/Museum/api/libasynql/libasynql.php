...
namespace Steellg0ld\Museum\api\libasynql;

use InvalidArgumentCountException;
use pocketmine\plugin\Plugin;
use pocketmine\utils\Terminal;
use pocketmine\utils\Utils;
use Steellg0ld\Museum\api\libasynql\base\DataConnectorImpl;
use Steellg0ld\Museum\api\libasynql\base\SqlThreadPool;
use Steellg0ld\Museum\api\libasynql\mysqli\MysqlCredentials;
use Steellg0ld\Museum\api\libasynql\mysqli\MysqliThread;
use Steellg0ld\Museum\api\libasynql\sqlite3\Sqlite3Thread;
...
final class libasynql{
	...
	public static function detectPackaged() : void{
		self::$packaged = __CLASS__ !== 'Steellg0ld\Museum\api\libasynql\libasynql';
