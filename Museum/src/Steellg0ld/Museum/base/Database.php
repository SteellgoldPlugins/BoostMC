...
class Database
{
    ...
    public function initialize(){
        Plugin::getInstance()->getDatabase()->getDatabase()->query("CREATE TABLE IF NOT EXISTS faction (faction VARCHAR(255) PRIMARY KEY, players TEXT, power int, money int, allies TEXT, description TEXT, claim_message TEXT, claims TEXT, chest TEXT, roles TEXT, dates TEXT, invests TEXT);");
